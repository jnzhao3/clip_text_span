...
declare -a commands=(
 [1]='WANDB_DIR=/global/scratch/users/jenniferzhao/wandb_logs HF_DATASETS_CACHE=/global/scratch/users/jenniferzhao/hf_datasets_cache python3 finetune.py --wandb_project clip-cifar-finetuning-semantic --dataset cifar100 --batch_size 32 --epochs 30000 --model_save_interval 1 --eval_interval 1 --semantic_shuffle True'
)
